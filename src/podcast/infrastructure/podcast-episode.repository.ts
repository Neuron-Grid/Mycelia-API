...
export class PodcastEpisodeRepository {
    ...
    async findBySummaryId(
        ...
        try {
            ...
            this.logger.error(
                `Failed to find podcast episode by summary ID: ${error.message}`,
            );
            return null;
        }
    }
    ...
    async create(
        ...
        try {
            ...
            this.logger.error(
                `Failed to create podcast episode: ${error.message}`,
            );
            throw error;
        }
    }
    ...
    async update(
        ...
        try {
            ...
            this.logger.error(
                `Failed to update podcast episode: ${error.message}`,
            );
            throw error;
        }
    }
    ...
    async findByUser(
        ...
        try {
            ...
            const { count, error: countError } =
                await this.supabaseRequestService
                    .getClient()
                    .from("podcast_episodes")
            ...
            this.logger.error(
                `Failed to find podcast episodes: ${error.message}`,
            );
    ...
    async findById(
        ...
        try {
            ...
            this.logger.error(
                `Failed to find podcast episode by ID: ${error.message}`,
            );
            return null;
        }
    }
    ...
    async softDelete(id: number, userId: string): Promise<void> {
        try {
            ...
            this.logger.error(
                `Failed to soft delete podcast episode: ${error.message}`,
            );
            throw error;
        }
    }
    ...
    async findOldEpisodes(
        ...
        try {
            ...
            this.logger.error(
                `Failed to find old podcast episodes: ${error.message}`,
            );
            return [];
        }
    }
