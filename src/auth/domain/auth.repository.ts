export abstract class AuthRepositoryPort {
    abstract signUp(email: string, password: string, username: string): Promise<unknown>
    ...
    abstract forgotPassword(email: string, redirectUrl: string): Promise<unknown>
    abstract resetPassword(accessToken: string, newPassword: string): Promise<unknown>
