...
export class TagController {
    ...
    @ApiOperation({ summary: 'Create a hierarchical tag with advanced features' })
    @ApiResponse({
        status: 201,
    ...
    @ApiResponse({ status: 200, description: 'Returns tag hierarchy', type: [TagHierarchyDto] })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    @Get('hierarchy')
    ...
    @ApiResponse({ status: 200, description: 'Returns tag subtree', type: TagHierarchyDto })
    ...
    @ApiResponse({ status: 200, description: 'Returns tag path', type: TagWithPathDto })
    @ApiResponse({ status: 404, description: 'Tag not found' })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    @Get(':tagId/path')
    ...
    @ApiOperation({ summary: 'Get feed items filtered by tag (with optional child inclusion)' })
    @ApiParam({ name: 'tagId', description: 'ID of the tag' })
    @ApiQuery({
    ...
    @ApiOperation({ summary: 'Get subscriptions filtered by tag (with optional child inclusion)' })
    @ApiParam({ name: 'tagId', description: 'ID of the tag' })
    @ApiQuery({
        name: 'includeChildren',
        required: false,
    ...
    @ApiParam({ name: 'subscriptionId', description: 'ID of the subscription' })
    @ApiResponse({ status: 200, description: 'Subscription tagged successfully' })
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
