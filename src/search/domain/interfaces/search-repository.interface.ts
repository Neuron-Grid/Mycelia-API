...
export interface SearchRepository {
    searchFeedItems(userId: string, criteria: SearchCriteria): Promise<SearchResultEntity[]>
    searchSummaries(userId: string, criteria: SearchCriteria): Promise<SearchResultEntity[]>
    searchPodcastEpisodes(userId: string, criteria: SearchCriteria): Promise<SearchResultEntity[]>
    searchAll(userId: string, criteria: SearchCriteria): Promise<SearchResultEntity[]>
